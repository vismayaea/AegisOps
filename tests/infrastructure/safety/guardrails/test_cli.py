...
from infrastructure.safety.guardrails.cli import cmd_audit, cmd_init, cmd_rules, cmd_test
...
class TestCmdInit:
    def test_creates_starter_config(
        ...
        monkeypatch.setattr(
            "infrastructure.safety.guardrails.cli.get_default_rules_path", lambda: rules_path
        )
...
class TestCmdTest:
    def test_no_config_shows_message(
        ...
        monkeypatch.setattr(
            "infrastructure.safety.guardrails.cli.get_default_rules_path",
    ...
    def test_shows_matches(
        ...
        monkeypatch.setattr(
            "infrastructure.safety.guardrails.cli.get_default_rules_path", lambda: config
        )
...
class TestCmdAudit:
    def test_shows_entries(
        ...
        monkeypatch.setattr("infrastructure.safety.guardrails.cli.AuditLogger", lambda: audit)
