...
from integrations.tracer.tools.tracer_failed_tools_tool import get_failed_tools
...
def test_run_happy_path() -> None:
    ...
    with patch(
        "integrations.tracer.tools.tracer_failed_tools_tool.get_tracer_web_client",
