...
from integrations.azure_sql.tools.azure_sql_resource_stats_tool import get_azure_sql_resource_stats
...
def test_run_happy_path() -> None:
    ...
    with patch(
        "integrations.azure_sql.tools.azure_sql_resource_stats_tool.get_resource_stats",
