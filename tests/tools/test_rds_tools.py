...
from integrations.rds.tools.rds_describe_instance_tool import describe_rds_instance
from integrations.rds.tools.rds_events_tool import describe_rds_events
...
@patch("integrations.rds.tools.rds_describe_instance_tool.execute_aws_sdk_call")
...
@patch("integrations.rds.tools.rds_events_tool.execute_aws_sdk_call")
