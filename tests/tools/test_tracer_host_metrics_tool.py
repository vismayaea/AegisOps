...
from integrations.tracer.tools.tracer_host_metrics_tool import get_host_metrics
...
def test_run_happy_path() -> None:
    ...
    with (
        patch(
            "integrations.tracer.tools.tracer_host_metrics_tool.get_tracer_web_client",
            return_value=mock_client,
        ),
        patch(
            "integrations.tracer.tools.tracer_host_metrics_tool.validate_host_metrics",
