...
from integrations.tracer.tools.tracer_run_tool import get_tracer_run
...
def test_run_returns_run_result() -> None:
    ...
    with patch(
        "integrations.tracer.tools.tracer_run_tool.get_tracer_client", return_value=mock_client
    ):
