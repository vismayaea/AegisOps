...
from integrations.victoria_logs.tools import VictoriaLogsTool
...
class TestMetadata:
    ...
    def test_surfaces_includes_chat(self) -> None:
        # As a log-query tool, this should be visible in chat — mirrors
        # SplunkSearchTool. Asserting guards against accidental removal
        # during refactors.
...
class TestExecutorPathContract:
    ...
    def test_run_via_extract_params_succeeds(self) -> None:
        ...
        with patch("integrations.victoria_logs.tools.make_victoria_logs_client") as mock_factory:
