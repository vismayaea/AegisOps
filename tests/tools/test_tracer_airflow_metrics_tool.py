...
from integrations.tracer.tools.tracer_airflow_metrics_tool import get_airflow_metrics
...
def test_run_happy_path() -> None:
    ...
    with patch(
        "integrations.tracer.tools.tracer_airflow_metrics_tool.get_tracer_web_client",
