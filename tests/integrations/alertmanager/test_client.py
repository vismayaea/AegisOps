...
from integrations.alertmanager.client import (
    AlertmanagerClient,
...
def test_get_client_forwards_auth_config_to_httpx(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr("integrations.alertmanager.client.httpx.Client", _FakeClient)
...
def test_get_status_success(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr(
        "integrations.alertmanager.client.httpx.Client.get",
...
def test_get_status_network_error(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr("integrations.alertmanager.client.httpx.Client.get", _raise)
...
def test_get_status_calls_correct_endpoint(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr("integrations.alertmanager.client.httpx.Client.get", _fake_get)
