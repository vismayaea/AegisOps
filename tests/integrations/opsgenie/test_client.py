...
from integrations.opsgenie.client import (
    OpsGenieClient,
    OpsGenieConfig,
...
def test_list_alerts_success(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr(
        "integrations.opsgenie.client.httpx.Client.get",
...
def test_list_alerts_with_query(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr("integrations.opsgenie.client.httpx.Client.get", _fake_get)
...
def test_list_alerts_network_error(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr("integrations.opsgenie.client.httpx.Client.get", _raise)
    result = _client().list_alerts()
    assert result["success"] is False
...
def test_add_note_success(monkeypatch: pytest.MonkeyPatch) -> None:
    monkeypatch.setattr(
        "integrations.opsgenie.client.httpx.Client.post",
