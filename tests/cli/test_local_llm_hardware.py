...
MODULE = "surfaces.cli.wizard.local_llm.hardware"
...
class TestGetTotalRamGbLinux:
    def _call(self) -> float:
        from surfaces.cli.wizard.local_llm.hardware import _get_total_ram_gb
    ...
    def test_returns_fallback_on_open_failure(self) -> None:
        from surfaces.cli.wizard.local_llm.hardware import _FALLBACK_RAM_GB
...
class TestGetAvailableRamGbLinux:
    def _call(self, total: float) -> float:
        from surfaces.cli.wizard.local_llm.hardware import _get_available_ram_gb
...
class TestGetTotalRamGbUnknownPlatform:
    def test_returns_fallback_on_unrecognised_platform(self) -> None:
        from surfaces.cli.wizard.local_llm.hardware import _FALLBACK_RAM_GB, _get_total_ram_gb
...
class TestDetectHardware:
    ...
    def _detect(
        ...
        *,
        ...
        from surfaces.cli.wizard.local_llm.hardware import detect_hardware
    ...
    def test_fallback_ram_propagates(self) -> None:
        from surfaces.cli.wizard.local_llm.hardware import _FALLBACK_RAM_GB, detect_hardware
